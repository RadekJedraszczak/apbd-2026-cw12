...
namespace Hospital_Cf.Data;

public partial class HospitalDfContext : DbContext
{
    public HospitalDfContext()
    {
    }

    public HospitalDfContext(DbContextOptions<HospitalDfContext> options)
        : base(options)
    {
    }
